...
using Kododo.ConfigWay.SqlServer.Tests.Fixtures;
using Kododo.ConfigWay.UI;
using Microsoft.AspNetCore.Builder;
using Microsoft.AspNetCore.TestHost;
using Xunit;

namespace Kododo.ConfigWay.SqlServer.Tests.Integration;

[Collection("SqlServer")]
public class SqlServerApiTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fixture;
    private WebApplication _app    = null!;
    private HttpClient     _client = null!;

    public SqlServerApiTests(SqlServerFixture fixture) => _fixture = fixture;
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.AddConfigWay(x =>
        {
            ...
            x.UseSqlServer(_fixture.ConnectionString);
            x.AddUiEditor();
        });
    ...
    [Fact]
    public async Task UpdateConfiguration_PersistedToSqlServer_SurvivesAppRestart()
    {
